...
const chrome = require('selenium-webdriver/chrome')    // coloca o teste sem abrir a tela

Before(async function () {
    const options = new chrome.Options().headless()    // coloca o teste sem abrir a tela

    this.driver = await new Builder()
        .forBrowser('chrome')
        //.setChromeOptions(options)                   // coloca o teste sem abrir a tela
        .build()
